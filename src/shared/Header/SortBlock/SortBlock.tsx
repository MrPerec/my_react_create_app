  ...
  return (
    <div className={styles.sortBlock}>
      <div className={styles.sortTextBlock}>
        <svg className={styles.sortRocketIcon} viewBox='0 0 9 11' xmlns='http://www.w3.org/2000/svg'>
      ...
      <button className={styles.sortButton}>
        <svg className={styles.sortDropdownIcon} viewBox='0 0 10 6' xmlns='http://www.w3.org/2000/svg'>
          <path fillRule='evenodd' clipRule='evenodd' d='M5 6L-4.75832e-07 0.534122L0.541379 1.26775e-07L5 4.87405L9.45862 9.06345e-07L10 0.534123L5 6Z' />
        </svg>
      </button>
    </div>
  );
